	...
	ctagsRel.Flavors = []*cores.Flavor{
		{
			...
			Resource: &resources.DownloadResource{
				...
				URL:             "http://downloads.arduino.cc/tools/serial-discovery-linux32-v1.0.0.tar.bz2",
				Size:            1469113,
		...
		},
		{
			...
			Resource: &resources.DownloadResource{
				...
				URL:             "http://downloads.arduino.cc/tools/serial-discovery-linux64-v1.0.0.tar.bz2",
				Size:            1503971,
		...
		},
		{
			...
			Resource: &resources.DownloadResource{
				...
				URL:             "http://downloads.arduino.cc/tools/serial-discovery-windows-v1.0.0.zip",
				Size:            1512379,
		...
		},
		{
			...
			Resource: &resources.DownloadResource{
				...
				URL:             "http://downloads.arduino.cc/tools/serial-discovery-macosx-v1.0.0.tar.bz2",
				Size:            746132,
		...
		},
		{
			...
			Resource: &resources.DownloadResource{
				...
				URL:             "http://downloads.arduino.cc/tools/serial-discovery-linuxarm-v1.0.0.tar.bz2",
				Size:            1395174,
		...
		},
		{
			...
			Resource: &resources.DownloadResource{
				...
				URL:             "http://downloads.arduino.cc/tools/serial-discovery-linuxarm64-v1.0.0.tar.bz2",
				Size:            1402706,
