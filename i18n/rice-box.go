...
func init() {
	...
	file2 := &embedded.EmbeddedFile{
		Filename:    ".gitkeep",
		FileModTime: time.Unix(1593396125, 0),
	...
	file4 := &embedded.EmbeddedFile{
		Filename:    "it_IT.po",
		FileModTime: time.Unix(1593396146, 0),
	...
	file5 := &embedded.EmbeddedFile{
		Filename:    "pt_BR.po",
		FileModTime: time.Unix(1593396147, 0),
	...
	dir1 := &embedded.EmbeddedDir{
		Filename:   "",
		DirModTime: time.Unix(1593396147, 0),
