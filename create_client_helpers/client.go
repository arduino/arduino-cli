...
// Client is the ArduinoCreateV1 service client.
type Client struct {
	*goaclient.Client
	SsoSigner goaclient.Signer
...
// SetSsoSigner sets the request signer for the sso security scheme.
func (c *Client) SetSsoSigner(signer goaclient.Signer) {
	c.SsoSigner = signer
}
