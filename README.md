...
- [Linux 64 bit 0.3.0-alpha.preview](https://downloads.arduino.cc/arduino-cli/arduino-cli-0.3.0-alpha.preview-linux64.tar.bz2)
- [Linux 32 bit 0.3.0-alpha.preview](https://downloads.arduino.cc/arduino-cli/arduino-cli-0.3.0-alpha.preview-linux32.tar.bz2)
- [Linux ARM 0.3.0-alpha.preview](https://downloads.arduino.cc/arduino-cli/arduino-cli-0.3.0-alpha.preview-linuxarm.tar.bz2)
- [Windows 0.3.0-alpha.preview](https://downloads.arduino.cc/arduino-cli/arduino-cli-0.3.0-alpha.preview-windows.zip)
- [Mac OSX 0.3.0-alpha.preview](https://downloads.arduino.cc/arduino-cli/arduino-cli-0.3.0-alpha.preview-osx.zip)
