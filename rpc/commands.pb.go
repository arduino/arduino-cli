...
func (*Configuration) Descriptor() ([]byte, []int) {
	return fileDescriptor_commands_90b91d74d128eb5f, []int{0}
}
...
func (*InitReq) Descriptor() ([]byte, []int) {
	return fileDescriptor_commands_90b91d74d128eb5f, []int{1}
}
...
func (*InitResp) Descriptor() ([]byte, []int) {
	return fileDescriptor_commands_90b91d74d128eb5f, []int{2}
}
...
func (*DestroyReq) Descriptor() ([]byte, []int) {
	return fileDescriptor_commands_90b91d74d128eb5f, []int{3}
}
...
func (*DestroyResp) Descriptor() ([]byte, []int) {
	return fileDescriptor_commands_90b91d74d128eb5f, []int{4}
}
...
func (*RescanReq) Descriptor() ([]byte, []int) {
	return fileDescriptor_commands_90b91d74d128eb5f, []int{5}
}
...
func (*RescanResp) Descriptor() ([]byte, []int) {
	return fileDescriptor_commands_90b91d74d128eb5f, []int{6}
}
...
func (*UpdateIndexReq) Descriptor() ([]byte, []int) {
	return fileDescriptor_commands_90b91d74d128eb5f, []int{7}
}
...
func (*UpdateIndexResp) Descriptor() ([]byte, []int) {
	return fileDescriptor_commands_90b91d74d128eb5f, []int{8}
}
...
type ArduinoCoreClient interface {
	...
	PlatformSearch(ctx context.Context, in *PlatformSearchReq, opts ...grpc.CallOption) (ArduinoCore_PlatformSearchClient, error)
	PlatformList(ctx context.Context, in *PlatformListReq, opts ...grpc.CallOption) (ArduinoCore_PlatformListClient, error)
}
...
func (c *arduinoCoreClient) PlatformSearch(ctx context.Context, in *PlatformSearchReq, opts ...grpc.CallOption) (ArduinoCore_PlatformSearchClient, error) {
	stream, err := c.cc.NewStream(ctx, &_ArduinoCore_serviceDesc.Streams[7], "/arduino.ArduinoCore/PlatformSearch", opts...)
	if err != nil {
		return nil, err
	}
	x := &arduinoCorePlatformSearchClient{stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type ArduinoCore_PlatformSearchClient interface {
	Recv() (*PlatformSearchResp, error)
	grpc.ClientStream
}

type arduinoCorePlatformSearchClient struct {
	grpc.ClientStream
}

func (x *arduinoCorePlatformSearchClient) Recv() (*PlatformSearchResp, error) {
	m := new(PlatformSearchResp)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
func (c *arduinoCoreClient) PlatformList(ctx context.Context, in *PlatformListReq, opts ...grpc.CallOption) (ArduinoCore_PlatformListClient, error) {
	stream, err := c.cc.NewStream(ctx, &_ArduinoCore_serviceDesc.Streams[8], "/arduino.ArduinoCore/PlatformList", opts...)
	if err != nil {
		return nil, err
	}
	x := &arduinoCorePlatformListClient{stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type ArduinoCore_PlatformListClient interface {
	Recv() (*PlatformListResp, error)
	grpc.ClientStream
}

type arduinoCorePlatformListClient struct {
	grpc.ClientStream
}

func (x *arduinoCorePlatformListClient) Recv() (*PlatformListResp, error) {
	m := new(PlatformListResp)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
type ArduinoCoreServer interface {
	...
	PlatformSearch(*PlatformSearchReq, ArduinoCore_PlatformSearchServer) error
	PlatformList(*PlatformListReq, ArduinoCore_PlatformListServer) error
}
...
func _ArduinoCore_PlatformSearch_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(PlatformSearchReq)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(ArduinoCoreServer).PlatformSearch(m, &arduinoCorePlatformSearchServer{stream})
}

type ArduinoCore_PlatformSearchServer interface {
	Send(*PlatformSearchResp) error
	grpc.ServerStream
}

type arduinoCorePlatformSearchServer struct {
	grpc.ServerStream
}

func (x *arduinoCorePlatformSearchServer) Send(m *PlatformSearchResp) error {
	return x.ServerStream.SendMsg(m)
}

func _ArduinoCore_PlatformList_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(PlatformListReq)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(ArduinoCoreServer).PlatformList(m, &arduinoCorePlatformListServer{stream})
}

type ArduinoCore_PlatformListServer interface {
	Send(*PlatformListResp) error
	grpc.ServerStream
}

type arduinoCorePlatformListServer struct {
	grpc.ServerStream
}

func (x *arduinoCorePlatformListServer) Send(m *PlatformListResp) error {
	return x.ServerStream.SendMsg(m)
}
...
var _ArduinoCore_serviceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "PlatformSearch",
			Handler:       _ArduinoCore_PlatformSearch_Handler,
			ServerStreams: true,
		},
		{
			StreamName:    "PlatformList",
...
func init() { proto.RegisterFile("commands.proto", fileDescriptor_commands_90b91d74d128eb5f) }

var fileDescriptor_commands_90b91d74d128eb5f = []byte{
	...
	,
}
