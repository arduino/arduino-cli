...
func (*Configuration) Descriptor() ([]byte, []int) {
	return fileDescriptor_commands_18fb36c0a9a0836b, []int{0}
}
...
func (*InitReq) Descriptor() ([]byte, []int) {
	return fileDescriptor_commands_18fb36c0a9a0836b, []int{1}
}
...
func (*InitResp) Descriptor() ([]byte, []int) {
	return fileDescriptor_commands_18fb36c0a9a0836b, []int{2}
}
...
func (*DestroyReq) Descriptor() ([]byte, []int) {
	return fileDescriptor_commands_18fb36c0a9a0836b, []int{3}
}
...
func (*DestroyResp) Descriptor() ([]byte, []int) {
	return fileDescriptor_commands_18fb36c0a9a0836b, []int{4}
}
...
func (*RescanReq) Descriptor() ([]byte, []int) {
	return fileDescriptor_commands_18fb36c0a9a0836b, []int{5}
}
...
func (*RescanResp) Descriptor() ([]byte, []int) {
	return fileDescriptor_commands_18fb36c0a9a0836b, []int{6}
}
...
func (*UpdateIndexReq) Descriptor() ([]byte, []int) {
	return fileDescriptor_commands_18fb36c0a9a0836b, []int{7}
}
...
func (*UpdateIndexResp) Descriptor() ([]byte, []int) {
	return fileDescriptor_commands_18fb36c0a9a0836b, []int{8}
}
...
func (*UpdateLibrariesIndexReq) Descriptor() ([]byte, []int) {
	return fileDescriptor_commands_18fb36c0a9a0836b, []int{9}
}
...
func (*UpdateLibrariesIndexResp) Descriptor() ([]byte, []int) {
	return fileDescriptor_commands_18fb36c0a9a0836b, []int{10}
}
...
type ArduinoCoreClient interface {
	...
	BoardAttach(ctx context.Context, in *BoardAttachReq, opts ...grpc.CallOption) (*BoardAttachResp, error)
...
func (c *arduinoCoreClient) BoardAttach(ctx context.Context, in *BoardAttachReq, opts ...grpc.CallOption) (*BoardAttachResp, error) {
	out := new(BoardAttachResp)
	err := c.cc.Invoke(ctx, "/cc.arduino.core.rpc.ArduinoCore/BoardAttach", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *arduinoCoreClient) Compile(ctx context.Context, in *CompileReq, opts ...grpc.CallOption) (ArduinoCore_CompileClient, error) {
	stream, err := c.cc.NewStream(ctx, &_ArduinoCore_serviceDesc.Streams[2], "/cc.arduino.core.rpc.ArduinoCore/Compile", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *arduinoCoreClient) PlatformInstall(ctx context.Context, in *PlatformInstallReq, opts ...grpc.CallOption) (ArduinoCore_PlatformInstallClient, error) {
	stream, err := c.cc.NewStream(ctx, &_ArduinoCore_serviceDesc.Streams[3], "/cc.arduino.core.rpc.ArduinoCore/PlatformInstall", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *arduinoCoreClient) PlatformDownload(ctx context.Context, in *PlatformDownloadReq, opts ...grpc.CallOption) (ArduinoCore_PlatformDownloadClient, error) {
	stream, err := c.cc.NewStream(ctx, &_ArduinoCore_serviceDesc.Streams[4], "/cc.arduino.core.rpc.ArduinoCore/PlatformDownload", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *arduinoCoreClient) PlatformUninstall(ctx context.Context, in *PlatformUninstallReq, opts ...grpc.CallOption) (ArduinoCore_PlatformUninstallClient, error) {
	stream, err := c.cc.NewStream(ctx, &_ArduinoCore_serviceDesc.Streams[5], "/cc.arduino.core.rpc.ArduinoCore/PlatformUninstall", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *arduinoCoreClient) PlatformUpgrade(ctx context.Context, in *PlatformUpgradeReq, opts ...grpc.CallOption) (ArduinoCore_PlatformUpgradeClient, error) {
	stream, err := c.cc.NewStream(ctx, &_ArduinoCore_serviceDesc.Streams[6], "/cc.arduino.core.rpc.ArduinoCore/PlatformUpgrade", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *arduinoCoreClient) Upload(ctx context.Context, in *UploadReq, opts ...grpc.CallOption) (ArduinoCore_UploadClient, error) {
	stream, err := c.cc.NewStream(ctx, &_ArduinoCore_serviceDesc.Streams[7], "/cc.arduino.core.rpc.ArduinoCore/Upload", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *arduinoCoreClient) LibraryDownload(ctx context.Context, in *LibraryDownloadReq, opts ...grpc.CallOption) (ArduinoCore_LibraryDownloadClient, error) {
	stream, err := c.cc.NewStream(ctx, &_ArduinoCore_serviceDesc.Streams[8], "/cc.arduino.core.rpc.ArduinoCore/LibraryDownload", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *arduinoCoreClient) LibraryInstall(ctx context.Context, in *LibraryInstallReq, opts ...grpc.CallOption) (ArduinoCore_LibraryInstallClient, error) {
	stream, err := c.cc.NewStream(ctx, &_ArduinoCore_serviceDesc.Streams[9], "/cc.arduino.core.rpc.ArduinoCore/LibraryInstall", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *arduinoCoreClient) LibraryUninstall(ctx context.Context, in *LibraryUninstallReq, opts ...grpc.CallOption) (ArduinoCore_LibraryUninstallClient, error) {
	stream, err := c.cc.NewStream(ctx, &_ArduinoCore_serviceDesc.Streams[10], "/cc.arduino.core.rpc.ArduinoCore/LibraryUninstall", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *arduinoCoreClient) LibraryUpgradeAll(ctx context.Context, in *LibraryUpgradeAllReq, opts ...grpc.CallOption) (ArduinoCore_LibraryUpgradeAllClient, error) {
	stream, err := c.cc.NewStream(ctx, &_ArduinoCore_serviceDesc.Streams[11], "/cc.arduino.core.rpc.ArduinoCore/LibraryUpgradeAll", opts...)
	if err != nil {
		return nil, err
	}
...
type ArduinoCoreServer interface {
	...
	BoardAttach(context.Context, *BoardAttachReq) (*BoardAttachResp, error)
...
func _ArduinoCore_BoardAttach_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(BoardAttachReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ArduinoCoreServer).BoardAttach(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cc.arduino.core.rpc.ArduinoCore/BoardAttach",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ArduinoCoreServer).BoardAttach(ctx, req.(*BoardAttachReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
func init() { proto.RegisterFile("commands.proto", fileDescriptor_commands_18fb36c0a9a0836b) }

var fileDescriptor_commands_18fb36c0a9a0836b = []byte{
	// 885 bytes of a gzipped FileDescriptorProto
	,
}
