...
func (*CompileReq) Descriptor() ([]byte, []int) {
	return fileDescriptor_compile_c78fd652796933b5, []int{0}
}
...
func (*CompileResp) Descriptor() ([]byte, []int) {
	return fileDescriptor_compile_c78fd652796933b5, []int{1}
}
...
func init() { proto.RegisterFile("compile.proto", fileDescriptor_compile_c78fd652796933b5) }

var fileDescriptor_compile_c78fd652796933b5 = []byte{
