...
type CompileReq struct {
	...
	Jobs             int32     `protobuf:"varint,13,opt,name=jobs,proto3" json:"jobs,omitempty"`                                           // The max number of concurrent compiler instances to run (as `make -jx`). If jobs is set to 0, it will use the number of available CPUs as the maximum.
	Libraries        []string  `protobuf:"bytes,14,rep,name=libraries,proto3" json:"libraries,omitempty"`                                  // List of custom libraries paths separated by commas.
	OptimizeForDebug bool      `protobuf:"varint,15,opt,name=optimizeForDebug,proto3" json:"optimizeForDebug,omitempty"`                   // Optimize compile output for debug, not for release.
	ExportDir        string    `protobuf:"bytes,16,opt,name=export_dir,json=exportDir,proto3" json:"export_dir,omitempty"`                 // Optional: save the build artifacts in this directory, the directory must exist.
	Clean            bool      `protobuf:"varint,17,opt,name=clean,proto3" json:"clean,omitempty"`                                         // Optional: cleanup the build folder and do not use any previously cached build
	ExportBinaries   bool      `protobuf:"varint,18,opt,name=export_binaries,json=exportBinaries,proto3" json:"export_binaries,omitempty"` // When set to `true` the compiled binary will be copied to the export directory.
}
...
var file_commands_compile_proto_rawDesc = []byte{
	...
	0x6f, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xd7, 0x04, 0x0a, 0x0a, 0x43, 0x6f, 0x6d,
	...
	,
	...
	0x20, 0x01, 0x28, 0x0c, 0x52, 0x09, 0x65, 0x72, 0x72, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x42,
