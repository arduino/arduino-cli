...
type BoardUploadDetailsRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	// (e.g., `arduino:avr:uno`).
	Fqbn string `protobuf:"bytes,2,opt,name=fqbn,proto3" json:"fqbn,omitempty"`
	// The protocol to use for uploading to the board.
	Protocol string `protobuf:"bytes,3,opt,name=protocol,proto3" json:"protocol,omitempty"`
	// The programmer to use for uploading to the board.
	Programmer string `protobuf:"bytes,4,opt,name=programmer,proto3" json:"programmer,omitempty"`
	// Custom upload properties to be used for uploading to the board.
	CustomUploadProperties []string `protobuf:"bytes,5,rep,name=custom_upload_properties,json=customUploadProperties,proto3" json:"custom_upload_properties,omitempty"`
	// If set to true, a burn-bootloader operation will be performed instead of a normal upload.
	BurnBootloader bool `protobuf:"varint,6,opt,name=burn_bootloader,json=burnBootloader,proto3" json:"burn_bootloader,omitempty"`
}

func (x *BoardUploadDetailsRequest) Reset() {
	*x = BoardUploadDetailsRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *BoardUploadDetailsRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BoardUploadDetailsRequest) ProtoMessage() {}

func (x *BoardUploadDetailsRequest) ProtoReflect() protoreflect.Message {
	mi := &file_cc_arduino_cli_commands_v1_board_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BoardUploadDetailsRequest.ProtoReflect.Descriptor instead.
func (*BoardUploadDetailsRequest) Descriptor() ([]byte, []int) {
	return file_cc_arduino_cli_commands_v1_board_proto_rawDescGZIP(), []int{3}
}

func (x *BoardUploadDetailsRequest) GetInstance() *Instance {
	if x != nil {
		return x.Instance
	}
	return nil
...
func (x *BoardUploadDetailsRequest) GetFqbn() string {
	if x != nil {
		return x.Fqbn
	}
	return ""
...
func (x *BoardUploadDetailsRequest) GetProtocol() string {
	if x != nil {
		return x.Protocol
	}
	return ""
...
func (x *BoardUploadDetailsRequest) GetProgrammer() string {
	if x != nil {
		return x.Programmer
	}
	return ""
...
func (x *BoardUploadDetailsRequest) GetCustomUploadProperties() []string {
	if x != nil {
		return x.CustomUploadProperties
	}
	return nil
}

func (x *BoardUploadDetailsRequest) GetBurnBootloader() bool {
	if x != nil {
		return x.BurnBootloader
	}
	return false
}

type BoardUploadDetailsResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// The platform properties used for uploading to the board with the specified protocol and configuration.
	UploadProperties map[string]string `protobuf:"bytes,1,rep,name=upload_properties,json=uploadProperties,proto3" json:"upload_properties,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	// The upload tools required for uploading to the board with the specified protocol and configuration.
	UploadTools []*ToolsDependencies `protobuf:"bytes,2,rep,name=upload_tools,json=uploadTools,proto3" json:"upload_tools,omitempty"`
}

func (x *BoardUploadDetailsResponse) Reset() {
	*x = BoardUploadDetailsResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *BoardUploadDetailsResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BoardUploadDetailsResponse) ProtoMessage() {}

func (x *BoardUploadDetailsResponse) ProtoReflect() protoreflect.Message {
	mi := &file_cc_arduino_cli_commands_v1_board_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BoardUploadDetailsResponse.ProtoReflect.Descriptor instead.
func (*BoardUploadDetailsResponse) Descriptor() ([]byte, []int) {
	return file_cc_arduino_cli_commands_v1_board_proto_rawDescGZIP(), []int{4}
}

func (x *BoardUploadDetailsResponse) GetUploadProperties() map[string]string {
	if x != nil {
...
func (x *BoardUploadDetailsResponse) GetUploadTools() []*ToolsDependencies {
	if x != nil {
		return x.UploadTools
	}
	return nil
}
...
func (x *BoardIdentifyResponse) Reset() {
	*x = BoardIdentifyResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_cc_arduino_cli_commands_v1_board_proto_msgTypes[23]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*BoardIdentifyResponse) Descriptor() ([]byte, []int) {
	return file_cc_arduino_cli_commands_v1_board_proto_rawDescGZIP(), []int{23}
}
...
var file_cc_arduino_cli_commands_v1_board_proto_rawDesc = []byte{
	...
	0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x90, 0x02, 0x0a, 0x19, 0x42, 0x6f, 0x61,
	0x72, 0x64, 0x55, 0x70, 0x6c, 0x6f, 0x61, 0x64, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x73, 0x52,
	...
	,
	...
	0x07, 0x50, 0x61, 0x63, 0x6b, 0x61, 0x67, 0x65, 0x12, 0x1e, 0x0a, 0x0a, 0x6d, 0x61, 0x69, 0x6e,
	0x74, 0x61, 0x69, 0x6e, 0x65, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x6d, 0x61,
	0x69, 0x6e, 0x74, 0x61, 0x69, 0x6e, 0x65, 0x72, 0x12, 0x10, 0x0a, 0x03, 0x75, 0x72, 0x6c, 0x18,
	0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x75, 0x72, 0x6c, 0x12, 0x1f, 0x0a, 0x0b, 0x77, 0x65,
	0x62, 0x73, 0x69, 0x74, 0x65, 0x5f, 0x75, 0x72, 0x6c, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x0a, 0x77, 0x65, 0x62, 0x73, 0x69, 0x74, 0x65, 0x55, 0x72, 0x6c, 0x12, 0x14, 0x0a, 0x05, 0x65,
	...
	0x04, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x34, 0x0a, 0x04, 0x68, 0x65, 0x6c, 0x70, 0x18, 0x06, 0x20,
	...
	0x01, 0x28, 0x09, 0x52, 0x06, 0x6f, 0x6e, 0x6c, 0x69, 0x6e, 0x65, 0x22, 0xd0, 0x01, 0x0a, 0x0d,
	...
	,
	...
	0x74, 0x65, 0x6d, 0x73, 0x52, 0x07, 0x73, 0x79, 0x73, 0x74, 0x65, 0x6d, 0x73, 0x22, 0x8a, 0x01,
	0x0a, 0x07, 0x53, 0x79, 0x73, 0x74, 0x65, 0x6d, 0x73, 0x12, 0x1a, 0x0a, 0x08, 0x63, 0x68, 0x65,
	0x63, 0x6b, 0x73, 0x75, 0x6d, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x63, 0x68, 0x65,
	0x63, 0x6b, 0x73, 0x75, 0x6d, 0x12, 0x12, 0x0a, 0x04, 0x68, 0x6f, 0x73, 0x74, 0x18, 0x02, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x04, 0x68, 0x6f, 0x73, 0x74, 0x12, 0x29, 0x0a, 0x10, 0x61, 0x72, 0x63,
	0x68, 0x69, 0x76, 0x65, 0x5f, 0x66, 0x69, 0x6c, 0x65, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x03, 0x20,
	...
	,
	...
	0x08, 0x73, 0x65, 0x6c, 0x65, 0x63, 0x74, 0x65, 0x64, 0x22, 0xcd, 0x01, 0x0a, 0x10, 0x42, 0x6f,
	0x61, 0x72, 0x64, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x40,
	...
	0x03, 0x52, 0x07, 0x74, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x12, 0x12, 0x0a, 0x04, 0x66, 0x71,
	0x62, 0x6e, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x66, 0x71, 0x62, 0x6e, 0x12, 0x49,
	0x0a, 0x22, 0x73, 0x6b, 0x69, 0x70, 0x5f, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x5f, 0x61, 0x70, 0x69,
	0x5f, 0x66, 0x6f, 0x72, 0x5f, 0x62, 0x6f, 0x61, 0x72, 0x64, 0x5f, 0x64, 0x65, 0x74, 0x65, 0x63,
	0x74, 0x69, 0x6f, 0x6e, 0x18, 0x04, 0x20, 0x01, 0x28, 0x08, 0x52, 0x1d, 0x73, 0x6b, 0x69, 0x70,
	0x43, 0x6c, 0x6f, 0x75, 0x64, 0x41, 0x70, 0x69, 0x46, 0x6f, 0x72, 0x42, 0x6f, 0x61, 0x72, 0x64,
	0x44, 0x65, 0x74, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x6f, 0x0a, 0x11, 0x42, 0x6f, 0x61,
	...
	0x74, 0x65, 0x64, 0x50, 0x6f, 0x72, 0x74, 0x52, 0x05, 0x70, 0x6f, 0x72, 0x74, 0x73, 0x12, 0x1a,
	0x0a, 0x08, 0x77, 0x61, 0x72, 0x6e, 0x69, 0x6e, 0x67, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x09,
	0x52, 0x08, 0x77, 0x61, 0x72, 0x6e, 0x69, 0x6e, 0x67, 0x73, 0x22, 0x98, 0x01, 0x0a, 0x0c, 0x44,
	0x65, 0x74, 0x65, 0x63, 0x74, 0x65, 0x64, 0x50, 0x6f, 0x72, 0x74, 0x12, 0x52, 0x0a, 0x0f, 0x6d,
	0x61, 0x74, 0x63, 0x68, 0x69, 0x6e, 0x67, 0x5f, 0x62, 0x6f, 0x61, 0x72, 0x64, 0x73, 0x18, 0x01,
	...
	0x0e, 0x6d, 0x61, 0x74, 0x63, 0x68, 0x69, 0x6e, 0x67, 0x42, 0x6f, 0x61, 0x72, 0x64, 0x73, 0x12,
	0x34, 0x0a, 0x04, 0x70, 0x6f, 0x72, 0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x20, 0x2e,
	0x63, 0x63, 0x2e, 0x61, 0x72, 0x64, 0x75, 0x69, 0x6e, 0x6f, 0x2e, 0x63, 0x6c, 0x69, 0x2e, 0x63,
	0x6f, 0x6d, 0x6d, 0x61, 0x6e, 0x64, 0x73, 0x2e, 0x76, 0x31, 0x2e, 0x50, 0x6f, 0x72, 0x74, 0x52,
	0x04, 0x70, 0x6f, 0x72, 0x74, 0x22, 0xac, 0x01, 0x0a, 0x13, 0x42, 0x6f, 0x61, 0x72, 0x64, 0x4c,
	0x69, 0x73, 0x74, 0x41, 0x6c, 0x6c, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x40, 0x0a,
	...
	0x20, 0x03, 0x28, 0x09, 0x52, 0x0a, 0x73, 0x65, 0x61, 0x72, 0x63, 0x68, 0x41, 0x72, 0x67, 0x73,
	...
	0x61, 0x72, 0x64, 0x73, 0x22, 0x59, 0x0a, 0x14, 0x42, 0x6f, 0x61, 0x72, 0x64, 0x4c, 0x69, 0x73,
	0x74, 0x41, 0x6c, 0x6c, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x41, 0x0a, 0x06,
	0x62, 0x6f, 0x61, 0x72, 0x64, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x29, 0x2e, 0x63,
	0x63, 0x2e, 0x61, 0x72, 0x64, 0x75, 0x69, 0x6e, 0x6f, 0x2e, 0x63, 0x6c, 0x69, 0x2e, 0x63, 0x6f,
	0x6d, 0x6d, 0x61, 0x6e, 0x64, 0x73, 0x2e, 0x76, 0x31, 0x2e, 0x42, 0x6f, 0x61, 0x72, 0x64, 0x4c,
	0x69, 0x73, 0x74, 0x49, 0x74, 0x65, 0x6d, 0x52, 0x06, 0x62, 0x6f, 0x61, 0x72, 0x64, 0x73, 0x22,
	0xa4, 0x01, 0x0a, 0x15, 0x42, 0x6f, 0x61, 0x72, 0x64, 0x4c, 0x69, 0x73, 0x74, 0x57, 0x61, 0x74,
	...
	0x65, 0x52, 0x08, 0x69, 0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x12, 0x49, 0x0a, 0x22, 0x73,
	0x6b, 0x69, 0x70, 0x5f, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x5f, 0x61, 0x70, 0x69, 0x5f, 0x66, 0x6f,
	0x72, 0x5f, 0x62, 0x6f, 0x61, 0x72, 0x64, 0x5f, 0x64, 0x65, 0x74, 0x65, 0x63, 0x74, 0x69, 0x6f,
	0x6e, 0x18, 0x02, 0x20, 0x01, 0x28, 0x08, 0x52, 0x1d, 0x73, 0x6b, 0x69, 0x70, 0x43, 0x6c, 0x6f,
	0x75, 0x64, 0x41, 0x70, 0x69, 0x46, 0x6f, 0x72, 0x42, 0x6f, 0x61, 0x72, 0x64, 0x44, 0x65, 0x74,
	0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x8b, 0x01, 0x0a, 0x16, 0x42, 0x6f, 0x61, 0x72, 0x64,
	...
	0x12, 0x3c, 0x0a, 0x04, 0x70, 0x6f, 0x72, 0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x28,
	0x2e, 0x63, 0x63, 0x2e, 0x61, 0x72, 0x64, 0x75, 0x69, 0x6e, 0x6f, 0x2e, 0x63, 0x6c, 0x69, 0x2e,
	0x63, 0x6f, 0x6d, 0x6d, 0x61, 0x6e, 0x64, 0x73, 0x2e, 0x76, 0x31, 0x2e, 0x44, 0x65, 0x74, 0x65,
	0x63, 0x74, 0x65, 0x64, 0x50, 0x6f, 0x72, 0x74, 0x52, 0x04, 0x70, 0x6f, 0x72, 0x74, 0x12, 0x14,
	0x0a, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x65,
	0x72, 0x72, 0x6f, 0x72, 0x22, 0x96, 0x01, 0x0a, 0x0d, 0x42, 0x6f, 0x61, 0x72, 0x64, 0x4c, 0x69,
	...
	,
	...
	,
	...
	,
...
var file_cc_arduino_cli_commands_v1_board_proto_msgTypes = make([]protoimpl.MessageInfo, 27)
var file_cc_arduino_cli_commands_v1_board_proto_goTypes = []any{
	...
	(*BoardUploadDetailsRequest)(nil),     // 3: cc.arduino.cli.commands.v1.BoardUploadDetailsRequest
	(*BoardUploadDetailsResponse)(nil),    // 4: cc.arduino.cli.commands.v1.BoardUploadDetailsResponse
	(*Package)(nil),                       // 5: cc.arduino.cli.commands.v1.Package
	(*Help)(nil),                          // 6: cc.arduino.cli.commands.v1.Help
	(*BoardPlatform)(nil),                 // 7: cc.arduino.cli.commands.v1.BoardPlatform
	(*ToolsDependencies)(nil),             // 8: cc.arduino.cli.commands.v1.ToolsDependencies
	(*Systems)(nil),                       // 9: cc.arduino.cli.commands.v1.Systems
	(*ConfigOption)(nil),                  // 10: cc.arduino.cli.commands.v1.ConfigOption
	(*ConfigValue)(nil),                   // 11: cc.arduino.cli.commands.v1.ConfigValue
	...
	(*BoardIdentifyRequest)(nil),          // 22: cc.arduino.cli.commands.v1.BoardIdentifyRequest
	(*BoardIdentifyResponse)(nil),         // 23: cc.arduino.cli.commands.v1.BoardIdentifyResponse
	nil,                                   // 24: cc.arduino.cli.commands.v1.BoardIdentificationProperties.PropertiesEntry
	nil,                                   // 25: cc.arduino.cli.commands.v1.BoardUploadDetailsResponse.UploadPropertiesEntry
	nil,                                   // 26: cc.arduino.cli.commands.v1.BoardIdentifyRequest.PropertiesEntry
	(*Instance)(nil),                      // 27: cc.arduino.cli.commands.v1.Instance
	(*Programmer)(nil),                    // 28: cc.arduino.cli.commands.v1.Programmer
	(*Port)(nil),                          // 29: cc.arduino.cli.commands.v1.Port
	(*Platform)(nil),                      // 30: cc.arduino.cli.commands.v1.Platform
}
var file_cc_arduino_cli_commands_v1_board_proto_depIdxs = []int32{
	27, // 0: cc.arduino.cli.commands.v1.BoardDetailsRequest.instance:type_name -> cc.arduino.cli.commands.v1.Instance
	5,  // 1: cc.arduino.cli.commands.v1.BoardDetailsResponse.package:type_name -> cc.arduino.cli.commands.v1.Package
	7,  // 2: cc.arduino.cli.commands.v1.BoardDetailsResponse.platform:type_name -> cc.arduino.cli.commands.v1.BoardPlatform
	8,  // 3: cc.arduino.cli.commands.v1.BoardDetailsResponse.tools_dependencies:type_name -> cc.arduino.cli.commands.v1.ToolsDependencies
	10, // 4: cc.arduino.cli.commands.v1.BoardDetailsResponse.config_options:type_name -> cc.arduino.cli.commands.v1.ConfigOption
	28, // 5: cc.arduino.cli.commands.v1.BoardDetailsResponse.programmers:type_name -> cc.arduino.cli.commands.v1.Programmer
	...
	24, // 7: cc.arduino.cli.commands.v1.BoardIdentificationProperties.properties:type_name -> cc.arduino.cli.commands.v1.BoardIdentificationProperties.PropertiesEntry
	27, // 8: cc.arduino.cli.commands.v1.BoardUploadDetailsRequest.instance:type_name -> cc.arduino.cli.commands.v1.Instance
	25, // 9: cc.arduino.cli.commands.v1.BoardUploadDetailsResponse.upload_properties:type_name -> cc.arduino.cli.commands.v1.BoardUploadDetailsResponse.UploadPropertiesEntry
	8,  // 10: cc.arduino.cli.commands.v1.BoardUploadDetailsResponse.upload_tools:type_name -> cc.arduino.cli.commands.v1.ToolsDependencies
	6,  // 11: cc.arduino.cli.commands.v1.Package.help:type_name -> cc.arduino.cli.commands.v1.Help
	9,  // 12: cc.arduino.cli.commands.v1.ToolsDependencies.systems:type_name -> cc.arduino.cli.commands.v1.Systems
	11, // 13: cc.arduino.cli.commands.v1.ConfigOption.values:type_name -> cc.arduino.cli.commands.v1.ConfigValue
	27, // 14: cc.arduino.cli.commands.v1.BoardListRequest.instance:type_name -> cc.arduino.cli.commands.v1.Instance
	14, // 15: cc.arduino.cli.commands.v1.BoardListResponse.ports:type_name -> cc.arduino.cli.commands.v1.DetectedPort
	19, // 16: cc.arduino.cli.commands.v1.DetectedPort.matching_boards:type_name -> cc.arduino.cli.commands.v1.BoardListItem
	29, // 17: cc.arduino.cli.commands.v1.DetectedPort.port:type_name -> cc.arduino.cli.commands.v1.Port
	27, // 18: cc.arduino.cli.commands.v1.BoardListAllRequest.instance:type_name -> cc.arduino.cli.commands.v1.Instance
	19, // 19: cc.arduino.cli.commands.v1.BoardListAllResponse.boards:type_name -> cc.arduino.cli.commands.v1.BoardListItem
	27, // 20: cc.arduino.cli.commands.v1.BoardListWatchRequest.instance:type_name -> cc.arduino.cli.commands.v1.Instance
	14, // 21: cc.arduino.cli.commands.v1.BoardListWatchResponse.port:type_name -> cc.arduino.cli.commands.v1.DetectedPort
	30, // 22: cc.arduino.cli.commands.v1.BoardListItem.platform:type_name -> cc.arduino.cli.commands.v1.Platform
	27, // 23: cc.arduino.cli.commands.v1.BoardSearchRequest.instance:type_name -> cc.arduino.cli.commands.v1.Instance
	19, // 24: cc.arduino.cli.commands.v1.BoardSearchResponse.boards:type_name -> cc.arduino.cli.commands.v1.BoardListItem
	27, // 25: cc.arduino.cli.commands.v1.BoardIdentifyRequest.instance:type_name -> cc.arduino.cli.commands.v1.Instance
	26, // 26: cc.arduino.cli.commands.v1.BoardIdentifyRequest.properties:type_name -> cc.arduino.cli.commands.v1.BoardIdentifyRequest.PropertiesEntry
	19, // 27: cc.arduino.cli.commands.v1.BoardIdentifyResponse.boards:type_name -> cc.arduino.cli.commands.v1.BoardListItem
...
func file_cc_arduino_cli_commands_v1_board_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_cc_arduino_cli_commands_v1_board_proto_msgTypes[3].Exporter = func(v any, i int) any {
			switch v := v.(*BoardUploadDetailsRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_cc_arduino_cli_commands_v1_board_proto_msgTypes[4].Exporter = func(v any, i int) any {
			switch v := v.(*BoardUploadDetailsResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_cc_arduino_cli_commands_v1_board_proto_msgTypes[22].Exporter = func(v any, i int) any {
		...
		file_cc_arduino_cli_commands_v1_board_proto_msgTypes[23].Exporter = func(v any, i int) any {
