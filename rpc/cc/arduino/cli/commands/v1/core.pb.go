...
func file_cc_arduino_cli_commands_v1_core_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_cc_arduino_cli_commands_v1_core_proto_msgTypes[14].Exporter = func(v interface{}, i int) interface{} {
		...
		file_cc_arduino_cli_commands_v1_core_proto_msgTypes[15].Exporter = func(v interface{}, i int) interface{} {
	...
	file_cc_arduino_cli_commands_v1_core_proto_msgTypes[1].OneofWrappers = []interface{}{
		(*PlatformInstallResponse_Progress)(nil),
		(*PlatformInstallResponse_TaskProgress)(nil),
		(*PlatformInstallResponse_Result_)(nil),
	}
	file_cc_arduino_cli_commands_v1_core_proto_msgTypes[4].OneofWrappers = []interface{}{
		(*PlatformDownloadResponse_Progress)(nil),
		(*PlatformDownloadResponse_Result_)(nil),
	}
	file_cc_arduino_cli_commands_v1_core_proto_msgTypes[6].OneofWrappers = []interface{}{
		(*PlatformUninstallResponse_TaskProgress)(nil),
		(*PlatformUninstallResponse_Result_)(nil),
	}
	file_cc_arduino_cli_commands_v1_core_proto_msgTypes[9].OneofWrappers = []interface{}{
