...
type MonitorRequest struct {
	...
	// If rx_msg_max_data_size>0 the data flow limiter will be enabled and the
	// server will send rx messages with an rx_data size limited to the amount
	// specified here. If rx_msg_max_data_size==0 the data flow limiter will be
	// disabled and the rx_data size will not be limited.
	RxMsgMaxDataSize int32 `protobuf:"varint,6,opt,name=rx_msg_max_data_size,json=rxMsgMaxDataSize,proto3" json:"rx_msg_max_data_size,omitempty"`
	// If the message speed limiter is enabled (rx_msg_max_data_size > 0) this
	// parameter will allow the server to send at most rx_msg_bucket_add messages
	// in addition to the number of messages previously allowed.
	RxMsgBucketAdd int32 `protobuf:"varint,7,opt,name=rx_msg_bucket_add,json=rxMsgBucketAdd,proto3" json:"rx_msg_bucket_add,omitempty"`
}
...
func (x *MonitorRequest) GetRxMsgMaxDataSize() int32 {
	if x != nil {
		return x.RxMsgMaxDataSize
	}
	return 0
}

func (x *MonitorRequest) GetRxMsgBucketAdd() int32 {
	if x != nil {
		return x.RxMsgBucketAdd
	}
	return 0
}
...
type MonitorResponse struct {
	...
	// The number of bytes dropped. This happens when:
	// * the rate limiter is enabled
	// * the client is not able to recharge the msg_bucket quickly enough
	// * the underlying monitor port does not have flow control to avoid data
	// loss.
	DroppedBytes int32 `protobuf:"varint,4,opt,name=dropped_bytes,json=droppedBytes,proto3" json:"dropped_bytes,omitempty"`
}
...
func (x *MonitorResponse) GetDroppedBytes() int32 {
	if x != nil {
...
func (x *EnumerateMonitorPortSettingsRequest) GetPort() *Port {
	if x != nil {
		return x.Port
	}
	return nil
...
var file_cc_arduino_cli_commands_v1_monitor_proto_rawDesc = []byte{
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xf5, 0x02, 0x0a, 0x0e, 0x4d, 0x6f, 0x6e, 0x69, 0x74,
	...
	0x69, 0x6f, 0x6e, 0x12, 0x2e, 0x0a, 0x14, 0x72, 0x78, 0x5f, 0x6d, 0x73, 0x67, 0x5f, 0x6d, 0x61,
	0x78, 0x5f, 0x64, 0x61, 0x74, 0x61, 0x5f, 0x73, 0x69, 0x7a, 0x65, 0x18, 0x06, 0x20, 0x01, 0x28,
	0x05, 0x52, 0x10, 0x72, 0x78, 0x4d, 0x73, 0x67, 0x4d, 0x61, 0x78, 0x44, 0x61, 0x74, 0x61, 0x53,
	0x69, 0x7a, 0x65, 0x12, 0x29, 0x0a, 0x11, 0x72, 0x78, 0x5f, 0x6d, 0x73, 0x67, 0x5f, 0x62, 0x75,
	0x63, 0x6b, 0x65, 0x74, 0x5f, 0x61, 0x64, 0x64, 0x18, 0x07, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0e,
	0x72, 0x78, 0x4d, 0x73, 0x67, 0x42, 0x75, 0x63, 0x6b, 0x65, 0x74, 0x41, 0x64, 0x64, 0x22, 0x66,
	...
	0x74, 0x74, 0x69, 0x6e, 0x67, 0x73, 0x22, 0xc0, 0x01, 0x0a, 0x0f, 0x4d, 0x6f, 0x6e, 0x69, 0x74,
	...
	,
	...
	0x61, 0x6c, 0x75, 0x65, 0x22, 0xb1, 0x01, 0x0a, 0x23, 0x45, 0x6e, 0x75, 0x6d, 0x65, 0x72, 0x61,
	0x74, 0x65, 0x4d, 0x6f, 0x6e, 0x69, 0x74, 0x6f, 0x72, 0x50, 0x6f, 0x72, 0x74, 0x53, 0x65, 0x74,
	0x74, 0x69, 0x6e, 0x67, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x40, 0x0a, 0x08,
	...
	0x70, 0x6f, 0x72, 0x74, 0x12, 0x12, 0x0a, 0x04, 0x66, 0x71, 0x62, 0x6e, 0x18, 0x03, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x04, 0x66, 0x71, 0x62, 0x6e, 0x22, 0x7c, 0x0a, 0x24, 0x45, 0x6e, 0x75, 0x6d,
	...
	0x12, 0x54, 0x0a, 0x08, 0x73, 0x65, 0x74, 0x74, 0x69, 0x6e, 0x67, 0x73, 0x18, 0x01, 0x20, 0x03,
	0x28, 0x0b, 0x32, 0x38, 0x2e, 0x63, 0x63, 0x2e, 0x61, 0x72, 0x64, 0x75, 0x69, 0x6e, 0x6f, 0x2e,
	...
	0x6e, 0x67, 0x44, 0x65, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x6f, 0x72, 0x52, 0x08, 0x73, 0x65,
	0x74, 0x74, 0x69, 0x6e, 0x67, 0x73, 0x22, 0x9e, 0x01, 0x0a, 0x1c, 0x4d, 0x6f, 0x6e, 0x69, 0x74,
	0x6f, 0x72, 0x50, 0x6f, 0x72, 0x74, 0x53, 0x65, 0x74, 0x74, 0x69, 0x6e, 0x67, 0x44, 0x65, 0x73,
	0x63, 0x72, 0x69, 0x70, 0x74, 0x6f, 0x72, 0x12, 0x1d, 0x0a, 0x0a, 0x73, 0x65, 0x74, 0x74, 0x69,
	0x6e, 0x67, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x73, 0x65, 0x74,
	0x74, 0x69, 0x6e, 0x67, 0x49, 0x64, 0x12, 0x14, 0x0a, 0x05, 0x6c, 0x61, 0x62, 0x65, 0x6c, 0x18,
	...
	0x04, 0x20, 0x03, 0x28, 0x09, 0x52, 0x0a, 0x65, 0x6e, 0x75, 0x6d, 0x56, 0x61, 0x6c, 0x75, 0x65,
...
var file_cc_arduino_cli_commands_v1_monitor_proto_depIdxs = []int32{
	...
	8, // 6: cc.arduino.cli.commands.v1.EnumerateMonitorPortSettingsRequest.port:type_name -> cc.arduino.cli.commands.v1.Port
